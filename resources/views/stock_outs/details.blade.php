...
<form>
    ...
    <div class="card p-2">
        <div class=" container-fluid toolbox mt-2 p-2">
            ...
            <a href="{{url('stock-out/print/'.$in->id)}}" class="btn btn-primary btn-sm btn-oval"
                target="_blank">
               ...
               <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span id="lb_in_date">: {{$in->out_date}}</span>
...
@section('script')
    ...
    <script>
        ...
        function saveMaster()
        {
            ...
            let con = confirm('តើអ្នកចង់រក្សាទុក?');
            if(con)
            {
                $.ajax({
                    type: "POST",
                    url: "/stock-out/master/save",
                    data: data,
